...
if __name__ == "__main__":
	...
	#os.path.join(TEXT_FOLDER,"cameras.txt")
    ...
    #os.path.join(TEXT_FOLDER,"images.txt")
	with open("images.txt", "r") as f:
		...
		for line in f:
			...
			if  i % 2 == 1:
				...
				name_depth = name.replace(".png", "_depth.png")
				...
				frame={"file_path":name,"depth_path":name_depth,"sharpness":b,"transform_matrix": c2w}
